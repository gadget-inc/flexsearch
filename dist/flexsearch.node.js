...
function na(a, b, c, d, e, f, g, h, k, m, q) {
  ...
  e && (z(e) || ((Y = e.split(":")), (e = 1 < Y.length ? pa : qa)), d.sort(e));
  d = Z(k, r, d);
  a.b && a.b.set(b, d);
  return d;
}
    ...
    for (var T = this.c; Q < x; Q++) {
      ...
      if (C) {
        if (p) {
          ...
          if (q && Q === x - 1 && !e.length) (p = !1), (C = l || C), (M[C] = 0);
          else if (!l) continue;
        }
        if (!M[C]) {
          var D = [],
          ...
          if (N) (l = C), (e[e.length] = 1 < H ? D.concat.apply([], D) : D[0]);
          else if (!q) {
            d = !1;
            break;
          }
...
function oa(a, b, c, d, e, f, g) {
  ...
  if (1 < m) {
    ...
    !m || (e && "not" === e[0]) || ((h = a[0]), k && (k = parseInt(k[0], 10)));
  if (b) {
    g = h.length;
    k && k > g && (k = 0);
    k = k || 0;
